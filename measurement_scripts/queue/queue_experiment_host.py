...
while(i):
	...
	while(j):
		...
		#fn = open(filename, "r+")
		subprocess.call(["sudo", "/home/ranjansv/pmdk-examples/cpp_queue/cpp_queue", "p", "/mnt/mem/pool135", "push", "10"])
		subprocess.call(["sudo", "/home/ranjansv/pmdk-examples/cpp_queue/cpp_queue", "p", "/mnt/mem/pool135", "pop"])
		#fn = fn.close()
		j = j-1
	end= time.time()
